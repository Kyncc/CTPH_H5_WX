<template>
  <div>
    ...
    <group class="weui_cells_form">
      ...
      <x-input name="code" placeholder="验证码" keyboard="number" class="weui_vcode" v-model="code"
    ...
    <x-button type="primary" style="margin-top: 20px;height: 50px;line-height: 50px;" @click.native="startLogin">登录
    </x-button>
  </div>
</template>
